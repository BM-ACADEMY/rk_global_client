  ...
  return (
    ...
    <div className="container">
      ...
      <div className="mission-vision-container" data-aos="fade-down">
        ...
        {/* Connecting Line */}
        <div className="connector" data-aos="scale-up" data-aos-delay="400">
      ...
      <div className="core-values-container" data-aos="fade-zoom-in">
        {/* Left Side - Image */}
        <div className="core-values-image" data-aos="flip-up" data-aos-delay="300">
